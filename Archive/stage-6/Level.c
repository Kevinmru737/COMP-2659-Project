...
void lvl_3(Model *model, UINT8 *game_state) {
    if(model->game_objects[2].bottom_right.x_pos <= 480) {
        model->num_active_objects = 12;
        initialize_game_object(608,271 - 31 , &(model->game_objects[5]), PLATFORM_BRICK_1);
        initialize_game_object(608,271 - 31 -16, &(model->game_objects[3]), PLATFORM_SHORT);
        initialize_game_object(608 - 32,271 - 31 , &(model->game_objects[4]), TRIANGLE);
		    initialize_game_object(700,271 - 31 -16, &(model->game_objects[6]), PLATFORM_SHORT);
        initialize_game_object(740 - 32,271 - 31 , &(model->game_objects[7]), TRIANGLE);
		initialize_game_object(780,271 - 31 -16, &(model->game_objects[8]), PLATFORM_SHORT);
        initialize_game_object(820 - 32,271 - 31 , &(model->game_objects[9]), TRIANGLE);
        
		initialize_game_object(780,271 - 31 -16-31, &(model->game_objects[10]), PLATFORM_BRICK_1);
		initialize_game_object(820,271 - 31 -16-31, &(model->game_objects[11]), PLATFORM_BRICK_1);
		(*game_state)++;
    }
...
void lvl_4(Model*model, UINT8* game_state) {
    if(model->game_objects[11].bottom_right.x_pos < 0) {
        ...
        initialize_game_object(608 - 32,271 - 68 , &(model->game_objects[1]), PLATFORM_SHORT);
        initialize_game_object(608,271 - 68, &(model->game_objects[2]), PLATFORM_SHORT);
        initialize_game_object(608 - 32,271 - 31 , &(model->game_objects[3]), TRIANGLE);
        initialize_game_object(608 ,271 - 31 , &(model->game_objects[4]), TRIANGLE);
        (*game_state)++;
    }
...
void lvl_6(Model*model, UINT8 *game_state) {
    ...
    if (model->game_objects[5].bottom_right.x_pos < 0) {
...
void lvl_8(Model*model, UINT8 *game_state){
   if (model->game_objects[6].bottom_right.x_pos < 0) {
        model->num_active_objects = 7;
        initialize_game_object(608,271 - 60, &(model->game_objects[1]), PLATFORM_SHORT);
        initialize_game_object(692,271 - 60, &(model->game_objects[2]), PLATFORM_SHORT);
        initialize_game_object(790,271 - 60, &(model->game_objects[3]), PLATFORM_SHORT);
        initialize_game_object(650,271 - 32  , &(model->game_objects[4]), TRIANGLE);
        initialize_game_object(734,271 - 32 , &(model->game_objects[5]), TRIANGLE);
        initialize_game_object(830,271 - 32  , &(model->game_objects[6]), TRIANGLE);
        (*game_state)++;
    }
...
void lvl_9(Model*model, UINT8 *game_state){
	 if (model->game_objects[6].bottom_right.x_pos < 0) {
        ...
        initialize_game_object(692,271 - 60, &(model->game_objects[2]), PLATFORM_SHORT);
        initialize_game_object(790,271 - 60, &(model->game_objects[3]), PLATFORM_SHORT);
		initialize_game_object(880,271 - 60, &(model->game_objects[4]), PLATFORM_SHORT);
        initialize_game_object(650,271 - 32  , &(model->game_objects[5]), TRIANGLE);
        initialize_game_object(734,271 - 32 , &(model->game_objects[6]), TRIANGLE);
        initialize_game_object(830,271 - 32  , &(model->game_objects[7]), TRIANGLE);
		 initialize_game_object(910,271 - 32  , &(model->game_objects[8]), TRIANGLE);
		 initialize_game_object(950,271 - 32  , &(model->game_objects[9]), TRIANGLE);
        (*game_state)++;
    }
