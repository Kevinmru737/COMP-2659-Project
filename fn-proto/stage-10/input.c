 ...
 *   exiting the application, based on the mouse's current X and Y coordinates.
 ****************************************************************************************/
CURSOR_STATUS  get_user_mouse_input() {
    ...
    /*Check if the click was within the y bounds of all buttons*/
    if (current_mouse_y_pos < ALL_BUTTONS_MIN_Y || current_mouse_y_pos > ALL_BUTTONS_MAX_Y) {
        return NO_SELECTION;
    }
