...
void main_game_loop() {
    ...
    orig_vbl_vector = install_vector(VBL_VECTOR_NUM, main_gm_vbl_isr);
...
void fatal_Collision_animation(UINT32* back_buffer, UINT32* front_buffer, UINT32* current_buffer, Model *model, short *num_times_ground_drawn){
    ...
    Vector orig_vbl_vector = install_vector(VBL_VECTOR_NUM, event_animation_vbl_isr);
...
void final_victory_animation(UINT32* back_buffer, UINT32* front_buffer, UINT32* current_buffer){
    ...
    orig_vbl_vector = install_vector(VBL_VECTOR_NUM, event_animation_vbl_isr);
