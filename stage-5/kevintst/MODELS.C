...
/*********************************************************
 * Purpose:  Sets the x any y position of the starting message
 *
 * Input:  y coordinate for ground position; pointer to the Ground struct.
 * Output: Ground struct initialized at specified y position.
 *
 ...
 *
 *********************************************************/
void initialize_message(int x, int y, int width, int height,
                        Game_Object * object, Game_Object_Type type) {
	object->top_left.x_pos = x;
    object->top_left.y_pos = y;
    object->type = type;
    object->object_velocity;
